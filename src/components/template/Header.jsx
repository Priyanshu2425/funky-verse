...
export default function Header(){
    ...
    function myFunction() {
        ...
        var offset2 = mobileheader.offsetHeight;
        window.innerWidth
    ...
    return (
        <>
            <div id="header">
                ...
                <div id="desktop-menu" className='sticky'>

                    

                    <div id="header-bar">
                        <Link className="link-component"  to="/"><div className='orbitron' style={{fontSize: '20px'}}>FUNKYVERSE</div></Link>
